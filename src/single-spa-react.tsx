...
export class SingleSpaReact<LifecycleFnProps extends IlcLifecycleFnProps>
  implements LifeCycles<LifecycleFnProps> {
  ...
  update? = async (props: LifecycleFnProps) => {
    ...
    this.reactDomRender(elementToRender, this.domElements[props.name], true);
  };
...
export default function ilcAdapterReact<T extends IlcLifecycleFnProps>(
  userOpts: AdapterOpts<T>
) {
